...
// import {
//   getSelectedTshareNFT,
//   getUserData,
//   getBalances,
//   changeSelectedTshareNFT,
...
//   const orders = useSelector((state) => state.data.selectedTshareNFT.orders);
//   const bestPrice = useSelector((state) => state.data.selectedTshareNFT.best);
//   const NFTinfo = useSelector((state) => state.data.selectedTshareNFT.nft);

//   const handleOrderChange = (event) => {
//     let index = event.target.value;
//     dispatch(changeSelectedTshareNFT(id, index));
//   };
...
//   useEffect(() => {
//     let getNFTs = async () => {
//       await dispatch(getSelectedTshareNFT(id));
//       setIsLoading(false);
//     };
...
//                   src={
//                     NFTinfo.Hash &&
//                     `https://ipfs.moralis.io:2053/ipfs/${NFTinfo.Hash}`
//                   }
//                   alt={NFTinfo.name}
//                 />
//               ) : (
