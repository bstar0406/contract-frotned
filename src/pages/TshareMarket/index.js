...
// import { getTshareMarketNFTs } from "../../redux/data/dataActions";
...
//   const marketTshareNFTbalance = useSelector((state) => state.data.tShareNFTs);
...
//           alignItems="center"
//         >
//           <Typography variant="h3">T-Shares MarketPlace</Typography>
//         </Grid>
//         <Grid
//           className="input_btn"
//           container
...
//         ) : (
//           <>
//             {marketTshareNFTbalance?.map((item) => {
