      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} lg={6} className="column">
          <Box className="heading_btn">
            ...
            <Typography variant="h6">{selectedNFT?.nft?.Artist}</Typography>
            <Typography variant="h6">{selectedNFT?.nft?.location}</Typography>
          ...
          <AssetSellTab
            props={{
              ...
              typeOfExperience: selectedNFT?.nft?.typeOfExperience,
              aboutWork: selectedNFT?.nft?.aboutWork,
              aboutArtist: selectedNFT?.nft?.aboutArtist,
            }}
          />
          ...
          <a href={selectedNFT?.nft?.certificate} rel="noreferrer" target="_blank">
            <Typography style={{ color: "#fff" }} variant="h6">
